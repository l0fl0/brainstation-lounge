...
export default function LoungePage() {
	...
	const showItems = { showTimer, showRadio, showStack, showChat, showNotes, showTasks, showSettings };
	...
	return (
		<main className='parent-container'>
			...
			<HeaderFrame showItems={showItems} />

			<section className='timer-container'>{isShowTimer ? <Timer /> : <></>}</section>
			<section className='radio-container'>{isShowRadio ? <Radio /> : <></>}</section>
			<section className='stack-container'>{isShowStack ? <Stack /> : <></>}</section>
			<section className='chat-container'>{isShowChat ? <Chat /> : <></>}</section>
			<section className='notes-container'>{isShowNotes ? <Notes /> : <></>}</section>
			<section className='tasks-container'>{isShowTasks ? <Tasks /> : <></>}</section>
			<section className='settings-container'>{isShowSettings ? <Settings prevGif={prevGif} nextGif={nextGif} setTwelveHourFormat={setTwelveHourFormat} /> : <></>}</section>
		</main>
	);
}
